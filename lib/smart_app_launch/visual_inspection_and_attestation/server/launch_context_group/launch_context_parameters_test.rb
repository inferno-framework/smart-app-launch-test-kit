module SMARTAppLaunch
  class LaunchContextParametersAttestationTest < Inferno::Test
    ...
    description %(
      The server supports the following launch context parameters:
    ...
    input :launch_context_parameters_correct,
          title: 'Supports launch context parameters',
          description: %(
    ...
    input :launch_context_parameters_note,
          title: 'Notes, if applicable:',
          type: 'textarea',
          optional: true

    run do
      assert launch_context_parameters_correct == 'true',
             'Server does not support all launch context parameters.'
      pass launch_context_parameters_note if launch_context_parameters_note.present?
    end
  end
end
