module SMARTAppLaunch
  class RefreshAccessTokensAttestationTest < Inferno::Test
    title 'Adheres to guidelines for refresh access tokens'
    id :refresh_access_tokens
    description %(
      Servers adhere to the following guidelines for refresh access tokens:
    ...
    input :refresh_tokens,
          title: 'Adheres to guidelines for refresh access tokens',
          description: %(
            I attest that the server adheres to the following guidelines for refresh access tokens:
            - Provides an app with "online-access" and can get new access tokens as long as the end-user remains online
            - Provides an app with "offline access" and can get new access tokens without the user being interactively
              engaged
    ...
    run do
      assert refresh_tokens == 'true',
             'Server did not adhere to guidelines for refresh access tokens.'
