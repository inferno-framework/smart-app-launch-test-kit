module SMARTAppLaunch
  class LaunchContextParametersAttestation < Inferno::Test
    title ''
    ...
    description %(
      ...
      - `smart_style_url` contains a string URL where the EHR's style parameters can be retrieved (for apps that support
         styling)
      - `tenant` contains a string conveying an opaque identifier for the healthcare organization that is launching the app
