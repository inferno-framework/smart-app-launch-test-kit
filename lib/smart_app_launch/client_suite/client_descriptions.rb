...
module SMARTAppLaunch
  ...
  INPUT_CLIENT_ID_DESCRIPTION_LOCKED = 
    "The registered Client Id for use in obtaining access tokens. #{RE_RUN_REGISTRATION_SUFFIX}"
  ...
  INPUT_SMART_LAUNCH_URLS_DESCRIPTION_LOCKED = 
    ...
    "will provide an option to use each to launch the app. #{RE_RUN_REGISTRATION_SUFFIX}"
  ...
  INPUT_SMART_REDIRECT_URIS_DESCRIPTION_LOCKED =
    ...
    "specified in authorization requests must come from this list. #{RE_RUN_REGISTRATION_SUFFIX}"
  ...
  INPUT_CLIENT_SECRET_DESCRIPTION_LOCKED = 
    ...
    "to Inferno. #{RE_RUN_REGISTRATION_SUFFIX}"
  ...
  INPUT_CLIENT_JWKS_DESCRIPTION_LOCKED = 
    ...
    "requests made by the client. #{RE_RUN_REGISTRATION_SUFFIX}"
  ...
  module ClientWaitDialogDescriptions
    ...
    def wait_dialog_backend_services_access_prefix(client_id)
      <<~EOS
        **Access**
    ...
    def wait_dialog_access_response_and_continue_suffix(resume_pass_url, client_id)
    <<~EOS
